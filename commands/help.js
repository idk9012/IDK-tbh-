...
module.exports = {
  ...
  execute(message) {
    ...
    helpEmbed.addField(`**Links!**`, `**[Support Server](${support_server || "https://discord.gg/"}) • [Invite](https://discord.com/oauth2/authorize?client_id=${message.client.user.id}&permissions=70282305&scope=bot)**`)
